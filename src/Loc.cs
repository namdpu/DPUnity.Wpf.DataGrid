...
namespace DPUnity.Wpf.DpDataGrid
{
    ...
    public class Loc
    {
        ...
        private static ILanguageDictionary Vietnamese { get; } = new LanguageDictionary("Vietnamese",
            new CultureInfo("vi"),
            new Dictionary<TranslatableElements, string>
            {
                        { TranslatableElements.All, "(Chọn tất cả)" },
                        { TranslatableElements.Empty, "(Trống)" },
                        { TranslatableElements.Clear, "Xóa bộ lọc \"{0}\"" },
                        { TranslatableElements.Contains, "Tìm kiếm (chứa)" },
                        { TranslatableElements.StartsWith, "Tìm kiếm (bắt đầu với)" },
                        { TranslatableElements.Toggle, "Chuyển đổi chứa/bắt đầu với" },
                        { TranslatableElements.Ok, "Lưu" },
                        { TranslatableElements.Cancel, "Hủy" },
                        { TranslatableElements.Status, "{0:n0} dòng được tìm thấy trên {1:n0}" },
                        { TranslatableElements.ElapsedTime, "Thời gian đã trôi qua {0:mm}:{0:ss}.{0:ff}" },
                        { TranslatableElements.True, "Đã chọn" },
                        { TranslatableElements.False, "Chưa chọn" },
                        { TranslatableElements.RemoveAll, "Xóa tất cả bộ lọc" },
                        { TranslatableElements.Indeterminate, "Không xác định" },
            });
